...
#   SCOPE: BruteForceIndex — реализация для учебной базы (631 уникальное имя, 699 объектов город×тип×имя, cdist по всем).
...
#   C-ADDRMATCH-PHASE-A T-004: index.py — словарь имён (631), фонетика/n-грам/Левенштейн
...
# затем оглушаем звонкие и редуцируем безударные гласные. Проверено на тестовых парах:
...
class BruteForceIndex:
    ...
    def candidates(self, street_q: str, k: int = 20, scope: Any = None) -> list[NameCand]:
        ...
        # Бюджет §5.3 (< 1 мс на 631 имя): process.cdist с DamerauLevenshtein (транспозиции)
        ...
        # уже отобранных top-k имён, а не для всех 631.
